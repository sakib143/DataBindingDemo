package com.example.databindingtest.data.repository
...
object Repository {
    ...
    val productMap: MutableMap<String, ProductModel> = HashMap()
    ...
    private fun addProduct(itemId: String, name: String, description: String, price: Double,
        ...
        val item = ProductModel(itemId, name, description, price, salePrice, rating, totalRatings, "$itemId.png",
            R.drawable.ic_error,
